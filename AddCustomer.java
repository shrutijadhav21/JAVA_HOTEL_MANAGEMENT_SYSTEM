		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String status =  t5.getText();
                                ...
                                String q1 = "insert into customer1 values('"+id+"','"+number+"','"+name+"','"+gender+"','"+country+"','"+room+"','"+status+"','"+deposite+"')";
                              
                                        String q2 = "update room set available = 'Occupied' where room_no = "+room;
